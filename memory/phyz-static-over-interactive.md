...
**Why:** An earlier attempt embedded a live diagram editor (React-in-Vue, ~2 MB lazy chunk) and it crashed in dev; the user's priority is a reliable, visible diagram in the docs, with editing happening externally.
