...
const groups = [
  ...
  },
  {
    ...
    soft: '#e0e7ff',
    items: [
      { number: '14', title: 'Path Integrals in Quantum Mechanics', desc: 'Connect sums over possible histories to quantum interference and classical motion.', link: '/path-integrals.html', symbol: 'eⁱˢ/ℏ' },
      { number: '15', title: 'Path Integrals for Fields', desc: 'See how field histories lead to the same propagators and Feynman diagrams.', link: '/path-integrals-fields.html', symbol: 'Z[J]' },
      { number: '16', title: 'Fermionic Path Integrals', desc: 'Understand how anticommuting variables preserve fermion exchange signs.', link: '/path-integrals-fermions.html', symbol: 'ψ̄, ψ' },
      { number: '17', title: 'Gauge Fixing', desc: 'Explain why redundant potentials require a gauge choice when calculating propagation.', link: '/path-integrals-gauge-fixing.html', symbol: '∂·A' },
      { number: '18', title: 'Renormalization at One Loop', desc: 'Connect regulated loop corrections to measured masses and interaction strengths.', link: '/path-integrals-renormalization.html', symbol: 'δm²' },
    ],
  },
  {
    number: '06',
    ...
    soft: '#fce7f3',
    items: [
      { number: '19', title: 'Weak Interaction', desc: 'Outline: beta decay, neutrinos, and interactions mediated by W bosons.', link: '/weak-interaction.html', symbol: 'W±' },
      { number: '20', title: 'Electroweak Unification', desc: 'Outline: describe weak and electromagnetic interactions in one gauge theory.', link: '/electroweak-unification.html', symbol: 'Z⁰' },
      { number: '21', title: 'Higgs Mechanism', desc: 'Outline: explain how the Higgs field gives mass to the W and Z bosons.', link: '/higgs-mechanism.html', symbol: 'H' },
    ],
  },
  {
    number: '07',
    ...
    soft: '#cffafe',
    items: [
      { number: '22', title: 'Quantum Chromodynamics', desc: 'Outline: color charge, gluons, and the confinement of quarks into hadrons.', link: '/qcd.html', symbol: 'SU(3)' },
      { number: '23', title: 'The Standard Model', desc: 'Outline: combine quarks, leptons, gauge fields, and the Higgs field.', link: '/standard-model.html', symbol: '3·2·1', final: true },
    ],
  },
]
</script>
  ...
  <div class="phyz-home">
    <section class="home-hero" aria-labelledby="home-title">
      ...
      <div class="field-visual" aria-hidden="true">
        ...
        <div class="formula formula-a">E = ℏω</div>
        <div class="formula formula-b">S = ∫ ℒ d⁴x</div>
