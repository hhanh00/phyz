...
The commutator $[\hat x, \hat p] = i\hbar$ alone determines the spectrum. The fastest way to see it is to combine $\hat x$ and $\hat p$ into a pair of operators that step between energy levels. Define
...
Inverting the definitions expresses $\hat x$ and $\hat p$ in terms of $\hat a$ and $\hat a^\dagger$. Substituting into $\hat H$ then turns the Hamiltonian into
